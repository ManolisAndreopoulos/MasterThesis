...
public class BlobManagerSDK : MonoBehaviour, IResourceManager
{
    #region Methods using depracated WindowsAzure.Storage package

    //[Header("Base Settings")]
    //[SerializeField]
    //private string connectionString = default;
    //[SerializeField]
    //private string projectName = "DepthVisualization";
    ///*
    ...
    //[SerializeField]
    //private string blockBlobContainerName = "ab-images"; //SOS: Must be lower-case
    //[SerializeField]
    //private bool tryCreateBlobContainerOnStart = true;

    //[Header("Resource")] 
    //[SerializeField] 
    //private RawImage AbRawImage = null;
    ...
    //{
    //     var result = await UploadBlobInternal();
    //}
    ...
    //private async Task<string> UploadBlobInternal()
    //{
    //    var blobName = "AbImage" + blobCounter + ".png";
    //    var image = (AbRawImage.texture as Texture2D).EncodeToPNG();
